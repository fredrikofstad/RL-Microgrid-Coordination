...
class Microgrid (object):
    ...
    def transition (self):
        ...
        if (self.actions_adjustingstatus[2 - 1] == 0
        or self.windspeed > cutoff_windspeed
        or self.windspeed < cutin_windspeed):
            workingstatus[2 - 1] = 0
        else:
            if (self.actions_adjustingstatus[2 - 1] == 1
    ...
    def OperationalCost(self):
        ...
        operational_cost += ((self.actions_discharged
                              + self.actions_solar[2 - 1]
                              + self.actions_wind[2 - 1]
                              + self.actions_generator[2 - 1])
    ...
    def SoldBackReward(self):
        ...
        return ((self.actions_solar[3-1] + self.actions_wind[3 -1] + self.actions_generator[3-1])
